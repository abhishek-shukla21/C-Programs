...
date:   19.08.22
program: WAP to sum of even numbers in an array
Example 1
Input
    4 9 5 80 10 2
Output
...
int main()
{
    ...
    puts("In this program we'll calculate the sum of the even integers in an array. "
    ...
    case RANDOM_ARRAY:
        ...
        for (int i = 0; i < a->size; i++) {
            ...
            a->sum_of_even_numbers += is_even(randomVal);
        }
    ...
    case ENTER_ELEMENTS:
        ...
        if (a != NULL) {
            for (int i = 0; i < a->size; i++) {
                ...
                a->sum_of_even_numbers += is_even(val);
            }
